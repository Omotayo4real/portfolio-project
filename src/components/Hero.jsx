...
const Hero = () => {
  return (
    <div className='bg-black text-white text-center py-16'>
      <img src={blackShoe} alt="" className='mx-auto mb-8 h-48 w-48 rounded-full 
      ...
      <div className='mt-8 space-x-4'>
          <button className="bg-gradient-to-r from-green-400 to-blue-500 text-white hidden
           md:inline transfrom transition-transform duration-300 hover:scale-105 px-4 py-2 rounded-full">
              Contact me</button>
