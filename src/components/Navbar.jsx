...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black text-white px-8 md:px-16 lg:px-24 fixed top-0 border-b border-gray-800 w-full z-10">
        <div className="container mx-auto py-5 flex lg:flex items-center justify-between">
